...
my $a=1;
my $b=2;
my $c=add_1($a,$b,10,58,9,8); # param1 => 
print($c); # 3
print("\n");

my @values = (10,20,30);
my @values1 = (100,200,300);

# $c = add_2(10,20,30);
$c = add_2(\@values,\@values1);
print("\n");
print($c); # 60


my $hello = say_hello("name"=>"DURAND","firstname"=>"Jean");
print($hello); # Bonjour Jean DURAND
print("\n");
